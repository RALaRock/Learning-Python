...
City, Country – population xxx, such as Santiago, Chile – population 5000000. 
...
Traceback (most recent call last):
  File "c:\Users\Robert\Python\learning\Learning-Python\CrashCourse\chapter 11\test_cities.py", line 14, in test_city_country     
    formatted_string = get_formatted_city_country("santiago", "chile")
TypeError: get_formatted_city_country() missing 1 required positional argument: 'population'
...
FAILED (errors=1)
"""
# modify city_functions() so that population is optional
# run test again to see if it passed
"""
.
----------------------------------------------------------------------
...
OK
"""
# created test with added population parameter
"""
..
----------------------------------------------------------------------
